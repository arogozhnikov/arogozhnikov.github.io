---
layout: post
title: Numbers and Naturalness, part 3
date: '2013-09-05T09:35:00.002-07:00'
author: Alex Rogozhnikov
tags:
- Theoretical physics
- P-adic numbers
modified_time: '2013-09-05T09:35:53.994-07:00'
blogger_id: tag:blogger.com,1999:blog-307916792578626510.post-4510337499848828401
blogger_orig_url: http://brilliantlywrong.blogspot.com/2013/09/numbers-and-naturalness-part-3.html
---

After we [learned]({% post_url 2013-07-21-real-numbers-and-naturalness-part-1 %}) [a bit]({% post_url 2013-07-22-numbers-and-naturalness-part-2 %}) about p-adic numbers, it's about time to get to the **naturalness**. Let me just discuss some hypotheses about the structure of the world we live in
...
But can we treat it (our geometrical imagination) as the argument to reject the hypothesis of p-adic space? Well, we can't. There are many examples in which our geometrical intuition fails to discover the real world ([non-Euclidean geometry](https://en.wikipedia.org/wiki/Non-Euclidean_geometry) is probably the most vivid one).
...
To be more precise, the elements of spacetime are partially ordered, but this ordering is based on comparison [distance in Minkowski space](https://en.wikipedia.org/wiki/Minkowski_space#The_Minkowski_inner_product) (which is obtained using arithmetic operations) and zero. Anyway, ordering is needed, and we [don't have it](http://brilliantlywrong.blogspot.ru/2013/08/soviet-computer.html) in p-adic numbers.
