...
This post is devoted to explanation what is __sPlot__. This well-known method was recently added to [hep_ml library](https://github.com/arogozhnikov/hep_ml).
