...
var DatasetSelector = function () {
    function DatasetSelector(wrapper_div, on_dataset_change) {
        ...
        var n_ticks = arguments.length <= 2 || arguments[2] === undefined ? 50 : arguments[2];
    ...
    _createClass(DatasetSelector, [{
        ...
        value: function collect_toy_datasets(axis_ticks) {
            ...
            for (var i = 0; i < z_grids.length; i++) {
                ...
                var _Utils$convert_grid_t2 = _slicedToArray(_Utils$convert_grid_t, 2);

                var trainX = _Utils$convert_grid_t2[0];
                var trainY = _Utils$convert_grid_t2[1];
...
var DecisionTreeVisualization = function () {
    ...
    _createClass(DecisionTreeVisualization, [{
        ...
        value: function compute_tree_prediction(depth) {
            ...
            var _dataset$get_current_2 = _slicedToArray(_dataset$get_current_, 3);

            var trainX = _dataset$get_current_2[0];
            var trainY = _dataset$get_current_2[1];
            var z_grid = _dataset$get_current_2[2];
...
var GradientBoostingInitialVisualization = function () {
    ...
    _createClass(GradientBoostingInitialVisualization, [{
        ...
        value: function compute_boosting_prediction(depth) {
            ...
            var _dataset$get_current_4 = _slicedToArray(_dataset$get_current_3, 3);

            var trainX = _dataset$get_current_4[0];
            var trainY = _dataset$get_current_4[1];
            var z_grid = _dataset$get_current_4[2];
...
var GradientBoostingBuildingVisuzalization = function () {
    ...
    _createClass(GradientBoostingBuildingVisuzalization, [{
        ...
        value: function compute_prediction_and_residual(depth, estimator) {
            ...
            var _dataset$get_current_6 = _slicedToArray(_dataset$get_current_5, 3);

            var trainX = _dataset$get_current_6[0];
            var trainY = _dataset$get_current_6[1];
            var function_z_grid = _dataset$get_current_6[2];
        ...
        value: function redraw() {
            ...
            var _compute_prediction_a2 = _slicedToArray(_compute_prediction_a, 3);

            var prediction = _compute_prediction_a2[0];
            var residual = _compute_prediction_a2[1];
            var tree_prediction = _compute_prediction_a2[2];
