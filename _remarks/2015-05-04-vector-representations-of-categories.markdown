...
blogger_orig_url: https://brilliantlywrong.blogspot.com/2015/05/vector-representations-of-categories.html
---
...
[wiki](https://en.wikipedia.org/wiki/Latent_Dirichlet_allocation)) to find good representation for categories.
...
3. To be more precise, the probability of each value within a category to be drawn for the event with $t_{event}$ vector is proportional to:
   ...
   So, to compute the final probability, one shall use the [softmax function](https://en.wikipedia.org/wiki/Softmax_function).
