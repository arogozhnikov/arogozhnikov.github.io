...
the results which you can expect from such a huge collective.  

So, the rule of statistical error says: __the progress is due to statistical error__.

From statistical physics we know that a system of $n$ particles has statistical error of observables around $\sqrt{n}$.
(also, the deviation of the sum of $n$ i.i.d. observables is proportional to $\sqrt{n}$).

This means, that

* if 1 person says that he works on properties of some quantum group, there is one man really working on this problem
* if 100 people say they are working on lattice modelling of some effect, the real job is done by 10 of them
...
So, the more 'widespread' the knowledge, the smaller the portion of people who are really into it — most people are just following trendy words.
Still, an area with 100x more researchers is developed 10x faster.