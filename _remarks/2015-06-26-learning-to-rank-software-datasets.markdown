...
thumbnail: https://3.bp.blogspot.com/-U_C84v4_WZU/VY2ollTlRHI/AAAAAAAAAFM/8G1c8hieciQ/s72-c/letor_number1.png
blogger_id: tag:blogger.com,1999:blog-307916792578626510.post-5222473215527059864
blogger_orig_url: https://brilliantlywrong.blogspot.com/2015/06/learning-to-rank-software-datasets.html
---
...
* [MSLR-WEB10k and MSLR-WEB30k](https://research.microsoft.com/en-us/projects/mslr/download.aspx)
...
* There is also [Yandex imat'2009](https://imat2009.yandex.ru/en/datasets) (Интернет-Математика 2009) dataset, which is rather small. (~100000 query-pairs in test and the same in train, 245 features).&nbsp;
...
1. LEMUR.Ranklib project incorporates many algorithms in C++<br /><a href="https://sourceforge.net/projects/lemur/">https://sourceforge.net/projects/lemur/</a><br />the best option unless you need implementation of something specific. Currently contains<br /><br />MART (=GBRT), RankNet, RankBoost, AdaRank, Coordinate Ascent, LambdaMART and ListNet
...
9. <a href="https://projects.yisongyue.com/svmmap/">SVM-MAP implementation</a> in C++
...
<caption>Taken from&nbsp;<a href="https://www2009.org/pdf/T7A-LEARNING%20TO%20RANK%20TUTORIAL.pdf">https://www2009.org/pdf/T7A-LEARNING%20TO%20RANK%20TUTORIAL.pdf</a></caption>
</figure>
...
<caption>Comparison from&nbsp;<a href="https://www.ke.tu-darmstadt.de/events/PL-12/papers/07-busa-fekete.pdf">https://www.ke.tu-darmstadt.de/events/PL-12/papers/07-busa-fekete.pdf</a>, <br />though paper was about comparison of nDCG implementations.</caption>
</figure>
