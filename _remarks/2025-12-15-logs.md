...
One log entry is written upon entrance to context manager, and one more on exit.
...
These systems are designed with causality tracking &mdash; hardly avoidable due to sheer amount of information.
I also should mention that in languages without GC keeping arbitrary context requires additional hassles.
