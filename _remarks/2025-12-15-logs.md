...
### What is usually tracked in a log?

Logs track events: API requests, file uploads/downloads, start and end of large subroutines, triggers, and, of course, errors with tracebacks; sometimes also progress indicators for heavy operations.

That is how logs work in practice.


### But what is a good log?
...
That would require tooling able to confirm that specific log records were *not* used, and I don't think anyone has implemented this yet.
...
In practice, logs are often poor at revealing root causes, which leads to stuffing every message with context—because reconstructing history from output produced by hundreds or thousands of processes is hard.


### Log level suggestions

Debates around `TRACE/DEBUG/INFO/WARN/ERROR/FATAL` are as old as log levels themselves.
...
**Remark:** I don't discuss here observability solutions that have an explicit (questionable) goal of tracking everything.
